      ...
      <div className="toolbar">
        <aside>
          <div className="toolbar__main-buttons">
            ...
            <button
              className={`toolbar__button ${viewMode ? "active" : ""}`}
            ...
            {!viewMode && (
              <button
                className={`toolbar__button ${openCreateNode ? "active" : ""}`}
            ...
            {!viewMode && (
              <button className="toolbar__button" onClick={toggleExportMode}>
                <ImageDownIcon />
              </button>
            )}
          </div>
          {openCreateNode && (
            <div className="toolbar__shapes-option">
              ...
              <button
                className="toolbar__button"
                onClick={handleAddParallelogram}
              >
                <ParallelogramIcon />
              </button>
